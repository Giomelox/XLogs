from app.back_end.funções.funções_conectar_email import aux_path_XML_destino, download_dir
from app.back_end.funções.funções_Gerais import obter_configs, navigate
